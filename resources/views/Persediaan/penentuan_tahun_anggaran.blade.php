...
<head>
    ...
    <title>Pengaturan Awal - Penentuan tahun anggaran</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1>Pengaturan Awal Aplikasi - Tahun Anggaran</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <div class="form-box">
                        ...
                        <div class="form-bottom">
                            <form action="{{ url('setting-tahun-anggaran') }}" method="post">
                                {{ csrf_field() }}
                                 <div class="form-group">
                                    <label for="form-username">Tahun Anggaran</label>
                                    <input type="text" name="thn_anggaran" placeholder="Masukan tahun anggaran" class="form-username form-control" required>
                                </div>

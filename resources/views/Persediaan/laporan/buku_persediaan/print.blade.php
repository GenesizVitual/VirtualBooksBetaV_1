...
<head>
    ...
    <title>Cetak Laporan Buku Persediaan</title>
    <style>
        table.table_nota {
            width: 100%;
            ...
            <div class="page">
                ...
                <table class="table_nota" id="customers" role="grid" border="1">
                    ...
                    @if(!empty($data_barang['data']))
                        @php($no=1)
                        @foreach($data_barang['data'] as $key=> $item_persediaan)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td style="width: 100px">{{ date('d-m-Y', strtotime($item_persediaan['tgl'])) }}</td>
                ...
                <table style="width: 100%; position: relative">
                    ...
                    <tr style="text-align: center; font-weight: bold;">
                        ...
                        <td >
                            ...
                            <br>
                            <label
                                style="text-decoration: underline">{{ $berwenang_2->nama }}</label>

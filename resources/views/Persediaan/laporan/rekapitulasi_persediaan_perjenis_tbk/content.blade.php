...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Rekapitulasi Persediaan Perjenis TBK</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Rekapitulasi Persediaan Perjenis TBK</li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-12">
                    <p style="color: darkgray">Halaman rekapitulasi persediaan Perjenis TBK akan menampilkan semua total dari belanja sesuai dengan jenis tanda bukti kas.</p>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-sm-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Panel Rekapitulasi Persediaan Perjenis TBK</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary collapsed-card">
                                        ...
                                        <div class="card-body" style="display: none;">
                                            <form action="{{ url('cetak-rekapitulasi-persediaan-perjenis-tbk') }}" method="post" target="_blank">
                                                {{ csrf_field() }}
                                                <div class="row">
                                                    <div class="col-md-4">

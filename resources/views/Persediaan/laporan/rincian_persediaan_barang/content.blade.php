                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary collapsed-card">
                                        ...
                                        <div class="card-body" style="display: none;">
                                            <form action="{{ url('rincian-stok-persediaan') }}" method="post"
                                                  target="_blank">
                                                {{ csrf_field() }}
                                                <div class="row">
                                                    <div class="col-md-4">
                                        ...
                                        <div class="card-header d-flex p-0">
                                            ...
                                            <ul class="nav nav-pills ml-auto p-2">
                                                <li class="nav-item dropdown">
                                                    <select class="form-control select2" id="response_klasifikasi">
                                                        @foreach($klasifikasi as $data_klasifikasi)
                                                            <option
                                                                value="{{ $data_klasifikasi->id }}">{{ $data_klasifikasi->nama }}</option>
                                                        @endforeach
...
@section('jsContainer')
    ...
    @include('Persediaan.laporan.rincian_persediaan_barang.js')
    <script>
        $(function () {

            $('.select2').select2();
            load_buku_persediaan($('#response_klasifikasi').val())

                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="kode" value="{{ $jenis_tbk->kode }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="jenis_tbk"><small style="color: red">*</small>Nama Jenis TBK</label>
                                                    <input type="text" class="form-control" name="jenis_tbk" value="{{ $jenis_tbk->jenis_tbk }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    @foreach($status_pembayaran as $key=> $keterangan)
                                                        <input  type="radio" name="status_pembayaran" value="{{ $key }}" @if($key==$jenis_tbk->status_pembayaran) checked @endif required> <label> {{ $keterangan }}</label><span style="padding: 2px;"></span>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>

...
class PembelianBarang extends Model
{
    ...
    protected $fillable = ['id_instansi','id_nota','id_penyedia','id_gudang','jumlah_barang','satuan','harga_barang','tanggal_expired','total_beli','total_ppn','total_pph','keterangan','parentID'];

...
Route::middleware([CheckLevel::class, CheckUser::class])->group(function () {
    ...
    # Preview Berita Acara pengeluaran
    Route::get('berita-acara-pengeluaran', 'Persediaan\MasterLaporan@preview_data_berita_acara_pengeluaran');
    # Preview Berita Acara pengeluaran
    Route::post('berita-acara-pengeluaran', 'Persediaan\MasterLaporan@print_data_berita_acara_pengeluaran');

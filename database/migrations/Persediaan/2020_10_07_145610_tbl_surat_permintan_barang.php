...
class TblSuratPermintanBarang extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_surat_permintaan_barang', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_surat_permintaan_barang');
    }
}
